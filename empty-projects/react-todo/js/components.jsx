...
(function() {
  ...
  var TodoApp = app.components.TodoApp = React.createClass({
    // Good pattern, react methods at top followed by your custom methods and then react at the bottom
    ...
    // called to render React Component
    render: function() {
      return (
      ...
      return (
        <div className="add-todo-group input-group input-group-lg">
          ...
          <span className="input-group-btn">
            <button onClick={this.handleNewTodo} className="btn btn-success" type="button" onClick={this.handleNewTodo}>
